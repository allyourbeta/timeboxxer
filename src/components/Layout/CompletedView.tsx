  ...
  const fetchCompletedTasks = async () => {
    ...
    try {
      ...
      const { data, error: fetchError } = await supabase
        .from("tasks")
        .select(
          "id, title, color_index, duration_minutes, completed_at, previous_list_id",
        )
    ...
    return (
      <div className="flex-1 overflow-y-auto p-6">
        <div className="mb-6">
          ...
          <button onClick={fetchCompletedTasks} className="btn-primary mt-2">
            Retry
          </button>
        </div>
      </div>
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-theme-secondary">
                  {task.duration_minutes} min • Completed{" "}
